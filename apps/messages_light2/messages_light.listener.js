...
exports.listener = function(type, event) {
  ...
  */
    ...
    if( Bangle.CLOCK || global.__FILE__ === undefined || global.__FILE__ === ".bootcde" ||  global.__FILE__.startsWith("messages_light2."))
    {
        ...
        if ("undefined"==typeof manageEvent)
        {
            ...
            callApp=function(event){
                require("Storage").writeJSON("messages_light2.NewEvent.json",event);
                load("messages_light2.app.js");
            }
        }
        else
        {
